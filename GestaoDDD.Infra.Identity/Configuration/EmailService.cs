    ...
    public class EmailService : IIdentityMessageService
    {
        ...
        private Task SendMail(IdentityMessage message)
        {
            if (ConfigurationManager.AppSettings["Internet"] == "true")
            {
                ...
                msg.From = new MailAddress("admin@agilizaorcamentos.com.br", "Equipe Agiliza");
        ...
        //        var msg = new MailMessage { From = new MailAddress("comunicação@agilizaorcamentos.com.br", "Equipe Agiliza") };
